...
enum BambuserError {
	...
	/// Server rejected client because of wrong username or password
...
/**
 * Used to enable/disable the video quality setting-selector
 */
#define kVideoQualityOption @"videoQuality"
/**
