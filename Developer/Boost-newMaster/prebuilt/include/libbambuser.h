 ...
 * broadcast, and is not related to the username.
 * This property should be set before calling #startBroadcasting.
 */
...
/**
 * \anchor username
 * Contains the username for authentication to the Bambuser video server.
 * This property should be set before calling #startBroadcasting, unless #applicationId is used.
 *
 * @deprecated Set #applicationId instead.
 */
@property (nonatomic, retain, setter = setUsername:, getter = username) NSString *username DEPRECATED_MSG_ATTRIBUTE("Replaced by applicationId");
/**
 * \anchor password
 * Contains the password for authentication to the Bambuser video server.
 * This property should be set before calling #startBroadcasting, unless #applicationId is used.
 *
 * @deprecated Set #applicationId instead.
 */
@property (nonatomic, retain, setter = setPassword:, getter = password) NSString *password DEPRECATED_MSG_ATTRIBUTE("Replaced by applicationId");
/**
 * \anchor orientation
 ...
 *
 * This method provides much faster startup than the deprecated init-method.
 ...
 *
 * The valid values for this parameter is kSessionPresetLow, kSessionPresetMedium, kSessionPresetHigh and kSessionPresetAuto.
 *
 ...
 *
 * The default value is kSessionPresetMedium.
 *
...
// These two don't direct to the new accessor, but to the new replacement property
- (NSString*) getUsername DEPRECATED_MSG_ATTRIBUTE("Replaced by applicationId");
- (NSString*) getPassword DEPRECATED_MSG_ATTRIBUTE("Replaced by applicationId");
/// @endcond
@end
